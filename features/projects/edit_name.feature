...
Feature: Edit project name
  ...
  @allow-rescue
  Scenario: Manager not allowed to set project name to more than 255 characters
    Given I am signed in as a manager
    And I own a project
    And there are 3 additional users of that project
    And there are 3 datapaths in that project
    When I am on the project page
    Then I should not be able to set project name to more than 255 characters
    And I should be able to edit the project name
